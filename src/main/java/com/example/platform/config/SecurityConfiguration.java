    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers( HttpMethod.GET,"/api/v1/tasks/task/**").authenticated()
                        .requestMatchers( HttpMethod.GET,"/api/v1/tasks/course/**").authenticated()
                        .requestMatchers( HttpMethod.GET,"/api/v1/tasks/myTask").authenticated()
                        ...
                        .requestMatchers( HttpMethod.POST,"/api/v1/tasks/**").hasAnyRole("ADMIN")//XDDDDDDDDDDDDD
                        .requestMatchers( HttpMethod.GET,"/api/v1/tasks/grouptask/**").authenticated()
                        .requestMatchers( HttpMethod.GET,"/api/v1/tasks/courseGroup/**").authenticated()
                        .requestMatchers( HttpMethod.GET,"/api/v1/tasks/myGroupTasks").hasAnyRole("USER")
                        .requestMatchers( HttpMethod.GET,"/api/v1/tasks/myGroupTasksAdmin").hasAnyRole("ADMIN")
                        .requestMatchers( HttpMethod.PATCH,"/api/v1/tasks/group").hasAnyRole("ADMIN")
